...
echo_and_run cd "/home/berat/test_turtlebot/src/turtlebot3/turtlebot3_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/berat/test_turtlebot/src/turtlebot3/turtlebot3_teleop/setup.py" \
     \
    build --build-base "/home/berat/test_turtlebot/build/turtlebot3/turtlebot3_teleop" \
    install \
    --root="${DESTDIR-/}" \
